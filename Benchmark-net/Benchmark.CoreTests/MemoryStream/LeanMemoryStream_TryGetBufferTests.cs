...
{
    public class LeanMemoryStream_TryGetBufferTests
    {
        [Fact]
        ...
        {
            var stream = new LeanMemoryStream(512);
        ...
        {
            var stream = new LeanMemoryStream(new byte[512]);
        ...
        {
            var stream = new LeanMemoryStream(new byte[512], writable: true);
        ...
        {
            var stream = new LeanMemoryStream(new byte[512], index: 0, count: 512);
        ...
        {
            var stream = new LeanMemoryStream(new byte[512], index: 0, count: 512, writable: true);
        ...
        {
            var stream = new LeanMemoryStream(new byte[512], index: 0, count: 512, writable: true, publiclyVisible: false);
        ...
        {
            var stream = new LeanMemoryStream(new byte[512], index: 0, count: 512, writable: true, publiclyVisible: true);
        ...
        {
            var stream = new LeanMemoryStream(array);
        ...
        {
            var stream = new LeanMemoryStream(array, writable: true);
        ...
        {
            var stream = new LeanMemoryStream(array.Array, index: array.Offset, count: array.Count);
        ...
        {
            var stream = new LeanMemoryStream(array.Array, index: array.Offset, count: array.Count, writable: true);
        ...
        {
            var stream = new LeanMemoryStream(array.Array, index: array.Offset, count: array.Count, writable: true, publiclyVisible: false);
        ...
        {
            var stream = new LeanMemoryStream(array.Array, index: array.Offset, count: array.Count, writable: true, publiclyVisible: true);
